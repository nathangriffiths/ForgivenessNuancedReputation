...
public class Simulation {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DonationGame game;
        if (!generosity && !fa && !ajd && !fr && er == 0.0 && ea == 0.0 && ep == 0.0) {
            ...
            if (generosity && (g1 > 0.0 || g2 > 0.0)) {
                ...
                if (learning) System.out.println("(with learning)");
                game = new ForgivenessDonationGame(n, m, q, mr, -imageSpread, imageSpread, preventNegativePayoffs, er, ea, ep, fa, ajd, fr, learning, beta);                
                if (learning) System.out.println("(with learning)");
            } else {
